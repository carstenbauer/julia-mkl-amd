...
OMP_NUM_THREADS=64 OMP_PLACES=cores OMP_PROC_BIND=close srun -u -n 1 -c 64 --cpu_bind=sockets /upb/departments/pc2/users/b/bauerc/.juliaup/bin/julia-beta --project ../bench.jl BLIS highAI
...
OMP_NUM_THREADS=64 OMP_PLACES=cores OMP_PROC_BIND=spread srun -u -n 1 -c 64 --cpu_bind=sockets /upb/departments/pc2/users/b/bauerc/.juliaup/bin/julia-beta --project ../bench.jl BLIS highMB
